...
var MonsterInsights = function() {
        ...
        function y(e) {
            ...
            if (h.match(/^javascript\:/i)) {
                t = 'internal'
            } else if (a(r) == 'tel' || a(r) == 'tel:') {
                t = 'tel'
            } else if (a(r) == 'mailto' || a(r) == 'mailto:') {
                t = 'mailto'
            } else if (g.length > 0 && c.length > 0 && !g.endsWith(c)) {
                t = 'external'
            } else if (o.length > 0 && p.length > 0) {
                for (n = 0, l = o.length; n < l; ++n) {
                    if (o[n].length > 0 && p.startsWith(o[n])) {
                        t = 'internal-as-outbound';
                        break
                    }
                }
            };
            if (t === 'unknown' && i.length > 0 && v.length > 0) {
                for (n = 0, l = i.length; n < l; ++n) {
                    if (i[n].length > 0 && h.endsWith(i[n])) {
                        t = 'download';
                        break
                    }
                }
                    ...
                    if (x || r == 'mailto' || r == 'tel') {
                        if (r == 'download') {
                            ...
                            a = {
                                ...
                                eventCategory: 'tel',
                                eventAction: c,
                                eventLabel: e.title.replace('tel:', ''),
                            };
                            t(e, a)
                        } else if (r == 'mailto') {
                            a = {
                                ...
                                eventAction: c,
                                eventLabel: e.title.replace('mailto:', ''),
                            };
                            t(e, a)
