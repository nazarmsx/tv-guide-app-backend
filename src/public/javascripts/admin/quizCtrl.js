...
app.controller('quizCtrl', ['$scope', '$location', '$rootScope', '$http', "$state", '$uibModal', 'LoginService', 'CategoryService', 'NotificationService', 'LangService', function ($scope, $location, $rootScope, $http, $state, $uibModal, LoginService, CategoryService, NotificationService, LangService) {
    ...
    $scope.removeQuestion = function (item) {
        ...
        $http({
            method: 'DELETE',
            url: '/api/quiz/' + item._id
        }).then(function (result) {
            console.log(result.data);
            $scope.addAlert(result.data.n + " quiz deleted.", 'success');
...
app.controller('quizEditController', ['$scope', '$location', '$rootScope', '$http', "$state", "$uibModal", '$uibModalInstance', 'config', function ($scope, $location, $rootScope, $http, $state, $uibModal, $uibModalInstance, config) {
    ...
    $scope.formatHtml = function (lang) {
        $scope.item.translations[lang].contents = html_beautify($scope.item.translations[lang].contents, {});
    };
